...
difference() {
	...
	union() {
		...
		translate(v = [7.5000000000, 30.0000000000, 60.0000000000]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [22.5000000000, -22.5000000000, -60.0000000000]) {
			rotate(a = [0, 90, 0]) {
		...
		translate(v = [22.5000000000, -7.5000000000, -60.0000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 15, r = 2.0000000000);
			}
		}
