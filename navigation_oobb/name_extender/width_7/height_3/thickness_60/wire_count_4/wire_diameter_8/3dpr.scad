...
difference() {
	...
	union() {
		...
		translate(v = [22.5000000000, 15.0000000000, 30.0000000000]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [-52.5000000000, -22.5000000000, -30.0000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 15, r = 4.0000000000);
			}
		}
		...
		translate(v = [-52.5000000000, -7.5000000000, -30.0000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 15, r = 4.0000000000);
			}
		}
